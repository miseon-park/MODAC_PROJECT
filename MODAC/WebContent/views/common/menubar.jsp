...
<body>
    ...
    <div id="nav-area" align="center">
        <ul id="mainMenu">
            <li><a href="<%= contextPath%>/views/camp-info/test.jsp">캠핑장 검색</a></li>
            <li><a href="<%=contextPath %>/noticeList">공지사항</a>
                <ul id="subMenu1">
                    <li><a href="<%=contextPath %>/noticeList">모닥불 소식</a></li>
                    <li><a href="<%=contextPath%>/campTipList">캠핑 팁</a></li>
                    <li><a href="<%=contextPath %>/qaList">Q&A</a></li>
