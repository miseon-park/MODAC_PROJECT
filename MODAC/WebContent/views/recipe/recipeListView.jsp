        ...
        <div class="content">
            ...
            <div class="content2">
				...
				<div class="card" style="width: 18rem">
					<input type="hidden" id="rno" name="rno" value="<%=r.getPostNo()%>"> 
						<img src="<%=contextPath%>/<%=r.getTitleImg()%>" width="200px" height="150px">

					<div class="card-body">
						<span><%=r.getMemberNo()%></span> <span class="date"><%=r.getCreateDate()%></span>
						<br>
						<br>
						<h5 class="card-title"><%=r.getPostTitle()%></h5>

						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
							fill="currentColor" class="bi bi-alarm" viewBox="0 0 16 16"> <path
