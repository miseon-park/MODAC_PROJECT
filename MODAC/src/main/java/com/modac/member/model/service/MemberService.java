...
public Member loginMember(String memberId , String memberPwd) {
	...
	public Member findId(String memberName, String email) {
		...
		Member m = new MemberDao().findId(memberName, email, conn);
		JDBCTemplate.close();
	 ...
	 * 비밀번호찾고변경
	 */
	public Member findupdatePwd(String memberId, String memberName, String email, String updatePwd) {
		Connection conn = JDBCTemplate.getConnection();
		...
		result = new MemberDao().findUpdatePwd(memberId, memberName, email, updatePwd,conn);
