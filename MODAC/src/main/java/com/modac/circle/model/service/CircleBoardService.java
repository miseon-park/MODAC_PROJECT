...
public ArrayList<Circle> selectList(PageInfo pi){
	Connection conn = JDBCTemplate.getConnection();
	
	ArrayList<Circle> list = new CircleBoardDao().selectList(conn, pi);
...
public int selectListCount() {
	Connection conn = JDBCTemplate.getConnection();
	int listCount = new CircleBoardDao().selectListCount(conn);
